...
export const MOBILE_AND_GADGETS = [
  "Mobile Phones",
  "Tablets",
  "Powerbanks",
...
export const CONSUMER_ELECTRONICS = [
  "Wearable Devices",
  "Tivi Accessories",
  "Gaming & Console",
  "Console Accessories",
...
export const MOMS_KIDS_AND_BABIES = [
...
export const COMPUTER_AND_ACCESSORIES = [
  "Desktop Computers",
  "Monitors",
